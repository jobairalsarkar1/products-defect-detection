...
# ✅ Use RGB (needed for pretrained MobileNetV2)
...
# Classification Report (✅ added zero_division fix)
report = classification_report(
    y_true, y_pred, target_names=test_gen.class_indices.keys(), zero_division=0
)
